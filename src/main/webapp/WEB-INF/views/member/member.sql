...
SELECT TIMESTAMPDIFF(DAY, lastDate, NOW()) from member2;
SELECT TIMESTAMPDIFF(DAY, lastDate, NOW()) from member2 where userDel='OK';

SELECT *,TIMESTAMPDIFF(DAY, lastDate, NOW()) as applyDiff from member2 order by idx desc;
